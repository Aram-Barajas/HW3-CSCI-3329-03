...
Class Distribution:
<img width="790" height="390" alt="image" src="https://github.com/user-attachments/assets/73e476e7-4fa3-4ca9-a073-46fb81b7e9ab" />
...
Missing values	dropna()	No missing values; safeguard step
Irrelevant columns	None dropped	Subject IDs retained for reference
Encoding	LabelEncoder on target	Target is string label; features numeric
...
Best algorithm: Logistic Regression, KNN, Gaussian NB, and Neural Network achieve perfect accuracy.
Variance / gaps: Only Perceptron shows variance; others are perfectly stable.
Dataset characteristics: 9 numeric features, 6 activity classes. Non-linear models perform well due to complex motion patterns.
4. Part 3 — Feature Selection
Search method: Exhaustive search over all 2⁹ − 1 = 511 non-empty subsets
Justification: With 9 features, exhaustive search is feasible. n_repeats reduced to 10 (100 evaluations per subset) for runtime balance. Guarantees globally optimal subset for each classifier.
...
<img width="989" height="490" alt="image" src="https://github.com/user-attachments/assets/8574cf5d-9539-4213-b43d-65789d318f13" />
...
Linear Classifier / Logistic Regression: Minimal effect from feature selection; models are robust.
KNN: Small improvements possible; removing irrelevant features reduces noise.
Gaussian NB: Gains from removing correlated features violating independence assumptions.
...
Models use default hyperparameters; tuning may affect rankings.
6. Reproduction
Python version: 3.10+
...
jupyter notebook hw3_test_im_accgyro.ipynb
